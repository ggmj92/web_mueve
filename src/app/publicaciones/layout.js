export const metadata = {
  title: 'Publicaciones',
  description:
    'Consulta las publicaciones, catálogos y material editorial de Mueve Galería. Descarga PDFs y explora contenido sobre arte contemporáneo.',
  keywords: [
    'publicaciones',
    'catálogos arte',
    'editorial arte',
  ...
  openGraph: {
    ...
    description:
      'Consulta las publicaciones, catálogos y material editorial de Mueve Galería.',
