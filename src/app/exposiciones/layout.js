export const metadata = {
  title: 'Exposiciones',
  description:
    'Explora las exposiciones actuales y pasadas de Mueve Galería. Descubre muestras de arte contemporáneo, instalaciones y eventos culturales.',
  keywords: [
    'exposiciones',
    'exposiciones arte',
    'muestras arte',
  ...
  openGraph: {
    ...
    description:
      'Explora las exposiciones actuales y pasadas de Mueve Galería.',
