export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'image',
      description:
        'Imagen de portada/preview que aparece al hacer hover. Usa el círculo (hotspot) para centrar la parte importante. Se mostrará como cuadrado (1:1).',
      options: {
        hotspot: true,
    ...
    },
    {
      ...
      type: 'file',
      description:
        'Sube un archivo PDF o proporciona un enlace externo (ej. Google Drive)',
      options: {
