export default {
    ...
    fields: [
        ...
        { name: 'english', type: 'text', title: 'Texto (Inglés)', options: { rows: 14 } },
        {
            ...
            type: 'object',
            description: 'Prensa en español - Sube un archivo PDF o proporciona un enlace externo',
            initialValue: {},
            fields: [
                {
                    name: 'file',
            ...
            validation: (Rule) => Rule.custom((prensa) => {
        ...
        },
        {
            ...
            title: 'Press (English)',
            type: 'object',
            description: 'Press in English - Upload a PDF file or provide an external link',
            initialValue: {},
            fields: [
                {
                    name: 'file',
