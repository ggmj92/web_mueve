export default function StructuredData({ type = 'Organization' }) {
  const organizationSchema = {
    ...
    alternateName: 'Mueve',
    description:
      'Galería de arte contemporáneo en Lima, Perú. Representamos artistas emergentes y establecidos, organizamos exposiciones innovadoras y participamos en ferias internacionales de arte.',
    ...
    sameAs: ['https://www.instagram.com/mueve.galeria'],
    address: {
      '@type': 'PostalAddress',
  ...
  const websiteSchema = {
    ...
    url: 'https://muevegaleria.com',
    description:
      'Mueve es una galería de arte contemporáneo que presenta exposiciones innovadoras y artistas emergentes.',
    publisher: {
      '@type': 'Organization',
      name: 'Mueve Galería',
      logo: {
