export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Obras',
      description:
        'Agregar obras para este artista. Haz clic en "Agregar elemento" para crear una nueva obra directamente aquí.',
      of: [
        {
          type: 'object',
          name: 'artwork',
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'array',
              description:
                'Agrega imágenes de detalle de esta obra. Heredarán automáticamente toda la información (año, técnica, medidas, descripción) de la obra principal.',
              of: [
                {
                  type: 'object',
                  name: 'detailImage',
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      type: 'boolean',
                      description:
                        'Marcar esta imagen de detalle como destacada para que aparezca como imagen principal (hero) en la página del artista.',
                      initialValue: false,
                    },
                    {
                      ...
                      type: 'boolean',
                      description:
                        'Marcar esta imagen de detalle como la que aparece en la vista previa al hacer hover sobre el nombre del artista.',
                      initialValue: false,
                    },
                  ],
                  preview: {
            ...
            },
            {
              ...
              type: 'boolean',
              description:
                'Marcar la imagen principal de esta obra como destacada para que aparezca como imagen hero en la página del artista.',
              initialValue: false,
            },
            {
              name: 'featuredPreview',
              ...
              type: 'boolean',
              description:
                'Marcar la imagen principal como la que aparece en la vista previa al hacer hover sobre el nombre del artista.',
              initialValue: false,
            },
          ],
          preview: {
