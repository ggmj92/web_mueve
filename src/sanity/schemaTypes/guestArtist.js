      ...
      of: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'image',
              description:
                'Usa el círculo (hotspot) para centrar la parte importante.',
              options: {
                hotspot: true,
              ...
              of: [
                {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      type: 'boolean',
                      description:
                        'Marcar como imagen principal (hero) en la página del artista.',
                      initialValue: false,
                    },
                    {
            ...
            },
            {
              ...
              type: 'boolean',
              description:
                'Usar como imagen hero en la página del artista invitado.',
              initialValue: false,
            },
            {
              name: 'featuredPreview',
              ...
              type: 'boolean',
              description:
                'Usar como hover preview en la lista de Mueve Estar.',
              initialValue: false,
            },
          ],
          preview: {
